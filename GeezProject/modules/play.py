...
async def play(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🤴 OWNERS", url="https://t.me/Itsbox),
                    InlineKeyboardButton("⛑ CHANEL", url="https://t.me/polovtasi"),
                ],
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/95a03c30d23d0e5520c98.jpg"
        ...
        try:
            ...
            while j < 5:
                ...
                toxxt += f" └ ⚡ __Powered by FOURTY MUSIC__\n\n"
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/95a03c30d23d0e5520c98.jpg"
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="⛑ Channel", url="https://t.me/polovtasi")],
        ]
    )
